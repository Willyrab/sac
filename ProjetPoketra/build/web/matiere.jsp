      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <div class="container my-4">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <form class="bg-light p-4 shadow" method="post" action="MatiereServlet">
                        <h2 class="mb-4 text-center">Inserer Matiere</h2>

                        <div class="mt-4 mb-3 row">
                            <div class="col-md-12">
                                <label for="exampleFormControlInput1">Nom de la matiere</label>
                                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Entrez le nom de la matiere" name="matiere">
                            </div>
                        </div>
